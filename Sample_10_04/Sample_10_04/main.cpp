...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    mainRenderTarget.Create(1280, 720, 1,1,DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_FORMAT_D32_FLOAT);
    ...
    CalcWeightsTableFromGaussian(weights, NUM_WEIGHTS, 8.0f);

    // step-3 横ブラー用のレンダリングターゲットを作成
    RenderTarget xBlurRenderTarget;
    xBlurRenderTarget.Create(640, 720, 1, 1, DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_FORMAT_D32_FLOAT);
    ...
    yBlurRenderTarget.Create(640, 360, 1, 1, DXGI_FORMAT_R8G8B8A8_UNORM, DXGI_FORMAT_D32_FLOAT);    
