...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    shadowMaps[0].Create(2048, 2048, 1, 1, DXGI_FORMAT_R32_FLOAT, DXGI_FORMAT_D32_FLOAT, clearColor);
    shadowMaps[1].Create(1024, 1024, 1, 1, DXGI_FORMAT_R32_FLOAT, DXGI_FORMAT_D32_FLOAT, clearColor);
    shadowMaps[2].Create(512, 512, 1, 1, DXGI_FORMAT_R32_FLOAT, DXGI_FORMAT_D32_FLOAT, clearColor);

    // step-4 分割エリアの最大深度値を定義する
    float cascadeAreaTbl[NUM_SHADOW_MAP] = {500, 2000, g_camera3D->GetFar()};
